...
export function resolveThreadRowClassName(input: {
  ...
  const baseClassName =
    "h-8 w-full translate-x-0 cursor-pointer justify-start rounded-lg border border-transparent px-2.5 text-left select-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring";

  if (input.isSelected && input.isActive) {
    return cn(
      baseClassName,
      "border-primary/35 bg-primary/22 text-foreground font-medium hover:bg-primary/26 hover:text-foreground dark:bg-primary/30 dark:hover:bg-primary/36",
    );
  }
  ...
  if (input.isSelected) {
    return cn(
      baseClassName,
      "border-primary/30 bg-primary/15 text-foreground hover:bg-primary/19 hover:text-foreground dark:bg-primary/22 dark:hover:bg-primary/28",
    );
  }
  ...
  if (input.isActive) {
    return cn(
      baseClassName,
      "border-border/70 bg-accent/85 text-foreground font-medium hover:bg-accent hover:text-foreground dark:bg-accent/60 dark:hover:bg-accent/75",
    );
  }

  return cn(
    baseClassName,
    "text-muted-foreground/95 hover:border-border/60 hover:bg-accent/70 hover:text-foreground",
  );
}
